...
let CustomersController = class CustomersController {
    ...
    async findAll(location, gender, search, sortBy, sortOrder) {
    ...
    async export(res, location, gender, search) {
...
__decorate([
    ...
    __param(0, (0, common_1.Query)('contact')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CustomersController.prototype, "getMetrics", null);
__decorate([
