...
export class InitialSchema1779519479015 implements MigrationInterface {
  name = 'InitialSchema1779519479015';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "item_price_history" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "price" numeric(10,2) NOT NULL, "changedAt" TIMESTAMP NOT NULL DEFAULT now(), "itemId" uuid, CONSTRAINT "PK_b4efa31733f94b697fedc2d961c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "order_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" integer NOT NULL, "priceAtOrder" numeric(10,2) NOT NULL, "orderId" uuid, "itemId" uuid, CONSTRAINT "PK_005269d8574e6fac0493715c308" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."order_status_history_status_enum" AS ENUM('Pending', 'Preparing', 'Ready to Deliver', 'Delivered', 'Cancelled')`,
    );
    await queryRunner.query(
      `CREATE TABLE "order_status_history" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "public"."order_status_history_status_enum" NOT NULL, "changedAt" TIMESTAMP NOT NULL DEFAULT now(), "changedBy" character varying NOT NULL DEFAULT 'Admin', "orderId" uuid, CONSTRAINT "PK_e6c66d853f155531985fc4f6ec8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."whatsapp_logs_status_enum" AS ENUM('Sent', 'Delivered', 'Failed')`,
    );
    await queryRunner.query(
      `CREATE TABLE "whatsapp_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "recipientName" character varying(150) NOT NULL, "recipientContact" character varying(50) NOT NULL, "triggeringEvent" character varying(100) NOT NULL, "status" "public"."whatsapp_logs_status_enum" NOT NULL, "errorMessage" text, "timestamp" TIMESTAMP NOT NULL DEFAULT now(), "orderId" uuid, CONSTRAINT "PK_cf09d6935d3e7c0c38a6eefb849" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."orders_status_enum" AS ENUM('Pending', 'Preparing', 'Ready to Deliver', 'Delivered', 'Cancelled')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "order_items" ADD CONSTRAINT "FK_e253fbd572683bcc785a70cbca7" FOREIGN KEY ("itemId") REFERENCES "items"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "whatsapp_logs" ADD CONSTRAINT "FK_940d96e11520ddb9025fb49bd5a" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "FK_e5de51ca888d8b1f5ac25799dd1" FOREIGN KEY ("customerId") REFERENCES "customers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "whatsapp_logs" DROP CONSTRAINT "FK_940d96e11520ddb9025fb49bd5a"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "item_price_history" DROP CONSTRAINT "FK_439897299212ad943404d5f16b7"`,
    );
