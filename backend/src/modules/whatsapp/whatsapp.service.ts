    ...
    return [
      {
        ...
        category: 'Utility',
        language: 'English (US)',
        text: "Hi {{1}}, thank you for ordering with Krunchy Brunchy!\n\n*Order #{{2}}*\n{{itemized order lines: item x qty - Rs. line total}}\n\n*Total: Rs. {{3}}*\n\nThanks for ordering! Your order will be prepared and delivered shortly.",
      },
      {
        id: 'order_preparing',
        ...
        category: 'Utility',
        language: 'English (US)',
        text: 'Hi {{1}}, we have started preparing your Krunchy Brunchy order #{{2}}!\n\n{{itemized order lines: item x qty - Rs. line total}}\n\n*Total: Rs. {{3}}*',
      },
      {
        id: 'ready_to_deliver',
        ...
        category: 'Utility',
        language: 'English (US)',
        text: 'Hi {{1}}, your Krunchy Brunchy order #{{2}} has been shipped!\n\n{{itemized order lines: item x qty - Rs. line total}}\n\n*Total Amount: Rs. {{3}}*',
      },
      {
        id: 'order_delivered',
        ...
        category: 'Utility',
        language: 'English (US)',
        text: "Hi {{1}}, your Krunchy Brunchy order #{{2}} has been successfully delivered!\n\n*Order #{{2}}*\n{{itemized order lines: item x qty - Rs. line total}}\n\n*Total: Rs. {{3}}*\n\nThank you for your purchase. Crunch on!",
      },
      {
        id: 'payment_received',
        ...
        category: 'Utility',
        language: 'English (US)',
        text: "Hi {{1}}, we've received your payment for order #{{2}}!\n\n{{itemized order lines: item x qty - Rs. line total}}\n\n*Amount Paid: Rs. {{3}}*\n\nThank you for choosing Krunchy Brunchy!",
      },
    ];
  }
